...
def train(cfg, writer, logger):
    ...
    train_or_pre = cfg["training"]["train_or_pre"]
    flag_SH      = cfg["training"]["flag_start_heatmap"]
    ...
    while i <= cfg["training"]["train_iters"] and flag:
        for data_batch in t_loader_batch:
            ...
            gt_labelmap_startpoint               = data_batch['gt_labelmap_start_heatmap']        # (bs, 1, h_rsz, w_rsz)
            ...
            gt_labelmap_startpoint  = gt_labelmap_startpoint.to(device)
            ...
            if n_channels_regression == 1:
                if train_or_pre:
                    loss_this = loss_seg + 1 * loss_centerline
                else:
                    loss_this = loss_seg
            elif n_channels_regression == 3:
