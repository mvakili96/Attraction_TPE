...
###
########################################################################################################################
def neg_loss_cond(pred, gt, channel_weights=None):
    ...
    if num_pos > 2:
        loss = loss - (pos_loss + neg_loss) / totnum_pixels
    else:
        loss = loss - (pos_loss + neg_loss) / totnum_pixels
...
###
########################################################################################################################
def neg_loss(preds, targets, channel_weights=None):
    #////////////////////////////////////////////////////////////////////////////////////////////////////////////
