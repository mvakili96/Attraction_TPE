...
class RailSem19_SegTriplet_b_Loader(data.Dataset):
    ...
    def __init__(self,
        ...
        self.dir_img_raw_jpg = dir_root_data_seg + 'LR_regu_railsem+ydhr/jpgs/'
        self.dir_img_heatmap = dir_root_data_seg + 'LR_regu_railsem+ydhr/Start_heatmap/'
        if self.n_classes == 19:
            self.dir_label_seg_png  = dir_root_data_seg     + 'uint8/rs19_val/'
        elif self.n_classes == 3:
            self.dir_label_seg_png = dir_root_data_seg + 'LR_regu_railsem+ydhr/Seg/'
        elif self.n_classes == 4:
            self.dir_label_seg_png = dir_root_data_seg + 'uint8/rs19_val_link_4class+ydhr/'



        if self.n_channels == 1:
            # self.dir_triplet_image   = dir_root_data_triplet + 'RailSemMJ_triplet_image/'
            self.dir_triplet_image     = dir_root_data_triplet + 'LR_regu_railsem+ydhr/C_image/'
            ...
            self.dir_triplet_C = dir_root_data_triplet + 'LR_regu_railsem+ydhr/C_image/'
            self.dir_triplet_L = dir_root_data_triplet + 'LR_regu_railsem+ydhr/L_image/'
            self.dir_triplet_R = dir_root_data_triplet + 'LR_regu_railsem+ydhr/R_image/'
        ...
        ###=============================================================================================
        self.fnames_img_heatmap = myhelper_railsem19_b.read_fnames_trainval(self.dir_img_heatmap, 7317)
    ...
    def __getitem__(self, index):
        ...
        full_fnames_img_heatmap   = self.dir_img_heatmap    + self.fnames_img_heatmap[self.type_trainval][index]
        ...
        ###=============================================================================================
        ### 1.4 read triplet image (from file)
        ###=============================================================================================
        if self.n_channels == 1:
        ...
        ###=============================================================================================
        ### 1.5 read Starting point heatmap
        ###=============================================================================================
        Start_heatmap = myhelper_railsem19_b.read_triplet_C_from_file(full_fnames_img_heatmap, self.size_img_rsz)
        ...
        output_Start_heatmap       = torch.from_numpy(Start_heatmap).float()
        ...
        if self.n_channels == 1:
            output_final = {'img_raw_fl_n'                   : output_img_raw,                              # (3, h_rsz, w_rsz)
                            ...
                            'gt_labelmap_start_heatmap'      : output_Start_heatmap}
